...
#             login_user(user, remember=True)  # Flask-Loginのlogin_user関数を使用
...
# # ログアウトのルート（Flask-Loginに対応）
# @app.route('/logout')
# def logout():
#     logout_user()  # Flask-Loginのlogout_user関数を使用
#     return redirect(url_for('login'))

# # Flask-Loginのlogin_requiredデコレータを使用するルート
# @app.route('/')
# @login_required #<---------------------------------これをログインが必要なルートへ記述する
# def index():
...
#         User.create_new_user("hoge","hogehoge") #　ログイン用のユーザーを追加する
